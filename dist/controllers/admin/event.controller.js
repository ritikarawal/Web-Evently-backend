...
const event_service_1 = require("../../services/admin/event.service");
...
class AdminEventController {
        ...
        try {
            ...
            if (event && event.organizer) {
                ...
                try {
                    ...
                    await notificationService.createNotification(organizerId, "Event Declined", `Your event "${event.title}" has been declined.${reasonMessage}`, "event_declined", eventId);
    ...
    async acceptUserBudgetProposal(req, res) {
        try {
            const { eventId } = req.params;
